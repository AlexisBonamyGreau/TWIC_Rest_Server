...
public class ApiController {
	...
	@RequestMapping(value="/api/all-villes", method=RequestMethod.GET)
	...
	@RequestMapping(value="/api/villes", method=RequestMethod.GET)
	...
	// Method POST
	@RequestMapping(value="/api/villes", method=RequestMethod.POST)
	...
	// Method PUT (update)
	@RequestMapping(value="/api/villes", method=RequestMethod.PUT)
	...
	// Method DELETE
	@RequestMapping(value="/api/villes", method=RequestMethod.DELETE)
